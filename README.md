...
> Capstone(Reactjs & Redux) is a web-app where you will see all the continents at home page.
> </br> By clicking on any of the continent you will be redirected to a new page with all the countries in it.
> </br> By clicking on any of the countries stats of the country will show up.
...
- **[Fetch data from API]**
- **[Show all the continents]**
- **[Show all the countires]**
- **[Show the stats of each & every specific country clicked]**
